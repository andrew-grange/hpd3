...
function sortBy(column) {
    if (sortCol == column) {
        if (sortDir == "up") {
            ...
            url = '../public/api/v1/index.php/owners';
...
function updateOwner(id) {
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            $.getJSON('../public/api/v1/index.php/owners', data, function(data) {
                owners = data;
...
function deleteOwner(ownerId) {
    ...
    url = '../public/api/v1/index.php/owners/' + ownerId;
...
function addItem(id) {
    sortCol = "notset"
    sortDir = "notset"
    url = '../public/api/v1/index.php/owners/' + id;
    var data = {
...
function showItems(id) {
    ...
    $(document).ready(function() {
        url = '../public/api/v1/index.php/owners/' + id + "/items";
        $.getJSON(url, function(data) {
...
function showOwners() {
    $.getJSON('../public/api/v1/index.php/owners', function(data) {
        owners = data;
...
function nextP() {
    ...
    xmlhttp.open("GET", "../public/api/v1/json_s.php?x=" + dbParam, true);
    xmlhttp.send();
