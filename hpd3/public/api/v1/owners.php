...
function createOwner($fname, $lname, $street1, $street2, $city, $state, $zip, $policy, $expiration) {
  ...
  global $mysqli;
  $sqlcreate = "INSERT INTO owners(fname, lname, street1, street2, city, state, zip, policy, expiration) VALUES('$fname', '$lname', '$street1', '$street2', '$city', '$state', '$zip', '$policy', '$expiration')";
